...
#ifndef COMISO_EIGEN_Cholmod_SOLVER_HH
#define COMISO_EIGEN_Cholmod_SOLVER_HH
...
//== CLASS DEFINITION =========================================================
class COMISODLLEXPORT EigenCholmodSolver
{
public:
  EigenCholmodSolver() : n_(0) {
    ldlt_.setMode(Eigen::CholmodLDLt);
  }
...
private:
  ...
  Eigen::CholmodDecomposition<Eigen::SparseMatrix<double>> ldlt_;
...
//=============================================================================
#if defined(INCLUDE_TEMPLATES) && !defined(COMISO_EIGEN_Cholmod_SOLVER_TEMPLATES_C)
#define COMISO_EIGEN_Cholmod_SOLVER_TEMPLATES
#include "EigenCholmodSolverT_impl.hh"
#endif
//=============================================================================
#endif // COMISO_EIGEN3_AVAILABLE
//=============================================================================
#endif // COMISO_EIGEN_Cholmod_SOLVER_HH defined
//=============================================================================
